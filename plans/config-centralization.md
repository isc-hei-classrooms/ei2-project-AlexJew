...
- [x] **12. Cleanup.** Delete all `*_latest.*` files under `data/` and `models/`. Update `README.md` to document the new config flow. Grep for any remaining hardcoded paths/cities/hyperparameters and migrate.
